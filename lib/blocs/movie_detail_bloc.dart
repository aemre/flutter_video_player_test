...
import 'package:flutterapp/resources/repository.dart';
...
class MovieDetailBloc {
  ...
  Stream<Future<ItemModel>> get similarMovies => _similarMovies.stream;

  Function(int) get fetchMovieDetailById => _movieId.sink.add;
  Stream<Future<MovieDetail>> get movieDetail => _movieDetail.stream;
